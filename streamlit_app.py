...
# Built-in assessments - no external dependencies needed
assessments = [
    {
    ...
    },
    {
        ...
        "url": "https://www.shl.com/products/assessments/behavioral-assessments/",
        "description": "Evaluates behavioral tendencies and work style preferences to predict job performance and cultural fit.",
        "test_type": "B",
        "remote_testing": True,
        "adaptive_irt": False
    }
...
def simple_keyword_search(query: str) -> List[Dict]:
    ...
    for assessment in assessments:
        ...
        keywords = ["java", "python", "programming", "personality", "cognitive", "technical", "numerical", "verbal", "situational", "customer", "mechanical", "behavioral"]
